...
if __name__ == "__main__":
    ...
    parser.add_argument('--weights', type=str, default='./weights/FastSAM-x.pt',
                        help='weights path')
    # parser.add_argument('--cfg', type=str, default='cfg/yolo_nas.cfg', help='config path')
    parser.add_argument('--output', type=str, default='./weights/fast_sam_1024.onnx',
                        help='output ONNX model path')
    parser.add_argument('--max_size', type=int, default=1024, help='max size of input image')
